...
gold 
    ...
    Precision is calculated at every rank where
...
gold 
    ...
    ahead of non-relevant documents.

    The number of non-relevant documents considered
    is limited to the number of relevant documents.
    """
...
def main ():
    ...
    print ("="*60 )
    print ("FIRE AILA STAGE 1 EVALUATION")
    print ("="*60 )
    ...
    cache_name ="fire_aila_bge_m3.npy"
    )
    ...
    print (
    "\nFIRE AILA evaluation completed."
    )
